...
public class BulletManager : MonoBehaviour
{
    ...
    public void CreateBullet(Vector3 position, Vector3 direction, Bullet.BulletMode mode, GameObject target = null)
    {
        ...
        bullet.InitializeBullet(position, correctedDirection, mode, target);
    }
